...
# ¡Selector de nombres aleatorios para sorteos de premios de GitHub!

:pray: Primero, ¡un gran saludo a [@icelam](https://github.com/icelam) por un selector de nombre excelente y simple que podríamos usar para el stand de GitHub!

:rocket: Este sitio se implementa en GitHub Pages usando GitHub Actions. El flujo de trabajo de acciones extrae participantes de los comentaristas de un problema de GitHub.

:ticket: Para participar en el sorteo (si lo hay), añade un comentario a [este error](/GH-Event-Demos/random-name-picker/issues/1)

---

A continuación se muestra el archivo README original:

---

<h1 align="center">Selector de nombre aleatorio para el sorteo de la suerte</h1>
<p align="center">
    Selector de nombre aleatorio HTML5 simple para elegir al ganador del sorteo utilizando animaciones web y API AudioContext
</p>
...
## DEMO en Vivo
La demostración está disponible en [https://pinkylam.me/playground/random-name-picker](https://pinkylam.me/playground/random-name-picker)
...
yarn build
```
Todos los archivos de compilación se pueden encontrar en la carpeta `/dist`
